...
<head>
    <title>login</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/jsps/backstage/login/login.css" type="text/css">
</head>
<body>
<div align="center">
    ...
    <div style="position: absolute;z-index: 1000;width: 100%;height: 100%">
        <div class="login_div">
            ...
            <h1 style="width:100%;color:white;margin-top: 20%">后台管理</h1>
            <form id="loginForm" action="<c:url value="/adminLogin.action"/>" method="post">
